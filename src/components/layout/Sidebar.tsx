...
import { Zap, LayoutDashboard, Users, Kanban, CheckSquare, BarChart2, Settings, LogOut, ChevronDown, Plug, FileText, Package, UserPlus, Receipt, Truck, BookOpen, Briefcase, PieChart } from 'lucide-react'
