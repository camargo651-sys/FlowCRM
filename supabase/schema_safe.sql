...
drop policy if exists "Workspace members can view profiles" on profiles;
...
drop policy if exists "Workspace owner manages pipelines" on pipelines;
...
drop policy if exists "Workspace owner manages stages" on pipeline_stages;
...
drop policy if exists "Workspace owner manages contacts" on contacts;
...
drop policy if exists "Workspace owner manages deals" on deals;
...
drop policy if exists "Workspace owner manages activities" on activities;
...
drop policy if exists "Workspace owner manages custom fields" on custom_field_defs;
...
drop policy if exists "Workspace owner manages integrations" on integrations;
...
drop policy if exists "Workspace owner manages quotes" on quotes;
...
drop policy if exists "Quote items follow quote access" on quote_items;
...
drop policy if exists "Workspace owner manages email accounts" on email_accounts;
...
drop policy if exists "Workspace owner manages email messages" on email_messages;
...
drop policy if exists "Email sync log follows account access" on email_sync_log;
...
drop policy if exists "Workspace owner manages whatsapp accounts" on whatsapp_accounts;
...
drop policy if exists "Workspace owner manages whatsapp messages" on whatsapp_messages;
...
drop policy if exists "Workspace owner manages whatsapp contacts" on whatsapp_contacts;
...
drop policy if exists "Workspace owner manages linkedin accounts" on linkedin_accounts;
...
drop policy if exists "Workspace owner manages linkedin connections" on linkedin_connections;
...
drop policy if exists "Workspace owner manages call logs" on call_logs;
...
drop policy if exists "Workspace owner manages signals" on engagement_signals;
...
drop policy if exists "Workspace owner manages automations" on automations;
...
drop policy if exists "Workspace owner manages quote views" on quote_views;
...
drop policy if exists "Workspace owner manages invitations" on team_invitations;
...
drop policy if exists "Workspace owner manages categories" on product_categories;
...
drop policy if exists "Workspace owner manages products" on products;
...
drop policy if exists "Workspace owner manages stock movements" on stock_movements;
...
drop policy if exists "Workspace owner manages api keys" on api_keys;
...
drop policy if exists "Workspace owner manages invoices" on invoices;
...
drop policy if exists "Invoice items follow invoice" on invoice_items;
...
drop policy if exists "Workspace owner manages payments" on payments;
...
drop policy if exists "Workspace owner manages suppliers" on suppliers;
...
drop policy if exists "Workspace owner manages purchase orders" on purchase_orders;
...
drop policy if exists "PO items follow PO" on purchase_order_items;
...
drop policy if exists "Workspace owner manages accounts" on chart_of_accounts;
...
drop policy if exists "Workspace owner manages journal entries" on journal_entries;
...
drop policy if exists "Journal lines follow entry" on journal_lines;
...
drop policy if exists "Workspace owner manages departments" on departments;
...
drop policy if exists "Workspace owner manages employees" on employees;
...
drop policy if exists "Workspace owner manages leave requests" on leave_requests;
...
drop policy if exists "Workspace owner manages payroll" on payroll_runs;
...
drop policy if exists "Payslips follow payroll" on payslips;
...
drop policy if exists "Workspace owner manages recurring invoices" on recurring_invoices;
...
drop policy if exists "Workspace owner views audit log" on audit_log;
...
drop policy if exists "ws owner pos_sessions" on pos_sessions;
...
drop policy if exists "ws owner pos_transactions" on pos_transactions;
...
drop policy if exists "ws owner pos_items" on pos_transaction_items;
...
drop policy if exists "ws owner attachments" on attachments;
...
drop policy if exists "ws owner approval_requests" on approval_requests;
...
drop policy if exists "ws owner product_variants" on product_variants;
...
drop policy if exists "ws owner expense_reports" on expense_reports;
...
drop policy if exists "ws owner expense_items" on expense_items;
...
drop policy if exists "ws owner bom" on bill_of_materials;
...
drop policy if exists "ws owner bom_lines" on bom_lines;
...
drop policy if exists "ws owner work_orders" on work_orders;
...
drop policy if exists "ws owner store_orders" on store_orders;
...
drop policy if exists "ws owner store_order_items" on store_order_items;
...
drop policy if exists "ws owner custom_roles" on custom_roles;
...
drop policy if exists "ws owner payment_milestones" on payment_milestones;
...
drop policy if exists "ws owner tickets" on tickets;
...
drop policy if exists "ws owner ticket_comments" on ticket_comments;
...
drop policy if exists "ws owner contracts" on contracts;
...
drop policy if exists "ws owner portal_tokens" on portal_tokens;
...
drop policy if exists "ws owner doc_templates" on document_templates;
